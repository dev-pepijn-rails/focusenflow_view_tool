require_relative 'lib/focusenflow_view_tool/version'

Gem::Specification.new do |spec|
  spec.name          = "focusenflow_view_tool"
  spec.version       = FocusenflowViewTool::VERSION
  spec.authors       = ["Pepijn van de Vorst"]
